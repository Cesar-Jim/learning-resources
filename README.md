...
![MERN](https://www.dropbox.com/s/rekvcb5xceathl9/mern3.png?raw=true "Current Focus In My Career")
...
* [Sorting Algorithms Animations](https://visualgo.net/en/sorting?slide=1)
...
* [Repl.it](https://repl.it/@cesarjim)
* [Codepen](https://codepen.io/dashboard/)
* [Prism syntax highlighter](https://prismjs.com/)
* [Free formatter (escape/unescap HTML)](https://www.freeformatter.com/html-escape.html)
* [Messenger bot for marketing)](https://chatfuel.com/)
* [Loupe - Understand call stack/event loop/callback queue)](https://chatfuel.com/)
* [Merge PDF files)](https://smallpdf.com/merge-pdf)
* [Firebase)](https://firebase.google.com/)
* [gitignore - A collection of popular gitignore templates)](https://github.com/github/gitignore)
* [Online UUID Generator)](https://www.uuidgenerator.net/)
* [Loom - free video sharing video service)](https://www.useloom.com/)
* [Bitbucket - Plan, collaborate on code, test and deploy)](https://bitbucket.org/)
* [db-Fiddle - practice SQL)](https://bitbucket.org/)
* [Gyazo - share instant screenshots & gifs)](https://gyazo.com/)
* [Grunt - JS task runner)](https://gruntjs.com/)
* [ ] [100+ Awesome Web Development Tools and Resources)](https://www.keycdn.com/blog/web-development-tools)
* [How to say or pronounce names)](https://www.pronouncenames.com)
* [ ] [MEAN stack - Starting Point)](http://mean.io/)
* [Explain shell - command line commands help)](https://explainshell.com/)
* [Rosiejs - Factory for building JS objects)](https://github.com/rosiejs/rosie)
* [Digital Ocean - Deploy, manage and scale cloud apps)](https://www.digitalocean.com/)
...
* [Postman - Simplifies API Development](https://www.getpostman.com/)
...
* [ ] [CSS Grid Template Builder](https://codepen.io/anthonydugois/pen/RpYBmy)

### Web Dev Jobs
---
* [x] [Webpack a detailed intro](https://www.smashingmagazine.com/2017/02/a-detailed-introduction-to-webpack/)
* [Mailtester)](http://mailtester.com/)

### Packages
---
* [ ] [Using dotenv package](https://medium.com/@thejasonfile/using-dotenv-package-to-create-environment-variables-33da4ac4ea8f)
* [Express](https://expressjs.com/)
* [Chai - BDD / TDD assertion library for node](https://www.chaijs.com/)
* [Mocha - feature-rich JavaScript test framework running on Node.js](https://mochajs.org/)
* [Faker - generate massive amounts of fake data](https://www.npmjs.com/package/faker)
* [ejs - View engine for JS](https://www.npmjs.com/package/ejs)
...
* [ ] [Flexbox Froggy - Flexbox Tutorial](https://flexboxfroggy.com/)
* [ ] [GridGuide - Grid Formatter](http://grid.guide/)
* [Sass](https://sass-lang.com/)
* [Balsamiq - UI design tool](https://balsamiq.com/)
* [Telegraphics - CO files and favicons](https://balsamiq.com/)
* [Sketch - tool for design process](https://www.sketchapp.com/)
* [Invision - product design platform](https://www.invisionapp.com/)
...
* [Grabient - create or import gradients](https://www.grabient.com/)
...
* [Lucid Chart - Diagram Creation](https://www.lucidchart.com/)
* [Zeplin - Project colaboration tool](https://zeplin.io/)
...
* [Codesignal - Coding assessments / practice for interviews](https://codesignal.com/)
